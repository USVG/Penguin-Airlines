...
//$stmt->bindValue(':genders', $genders);
        ...
        $sql = "INSERT INTO users (email, password, first_name, last_name, country, address, post_code, phone_number,date_of_birth, is_admin) 
VALUES(:email, :password, :first_name, :last_name,:country,:address, :post_code,:phone_number ,:date_of_birth, :is_admin)";
